...
-(void)showLeftView{
    [UIView beginAnimations:nil context:nil];
    mainControl.view.transform = CGAffineTransformScale(CGAffineTransformIdentity,1.0,1.0);
    mainControl.view.center = CGPointMake([UIScreen mainScreen].bounds.size.width*5/6 ,[UIScreen mainScreen].bounds.size.height/2);
    [UIView commitAnimations];
...
-(void)showRighView{
    [UIView beginAnimations:nil context:nil];
    mainControl.view.transform = CGAffineTransformScale(CGAffineTransformIdentity,1.0,1.0);
    mainControl.view.center = CGPointMake(-([UIScreen mainScreen].bounds.size.width/6),[UIScreen mainScreen].bounds.size.height/2);
    [UIView commitAnimations];
}
